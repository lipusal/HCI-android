...
public class FlightDetailsFragment extends Fragment {
    ...
    TextView firstPartDetail1;
    TextView firstPartDetail2;
    ...
    private void updateView(){
        ...
        if(arrivalAirport == null && departureAirport == null) {
            firstPartDetail1.setText("Not Found");
        }
        else {
...
//            arrivalDetail1.setText(arrivalAirport.getDescription());
            ...
            extraDetail.setText("STATUS: " + flightStatus.getStatus());
            /*extraDetail.setText(context.getString(R.string.extra_details) + "\n" +
                    ...
                    "GET DuRARAtotTIN"
                    + "\n" +
                    context.getString(R.string.equipage) + flightStatus.getBaggageClaim() + "\n" +
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        firstPartDetail1 = (TextView) view.findViewById(R.id.firstPartDetail1);
        firstPartDetail2 = (TextView) view.findViewById(R.id.firstPartDetail2);
